...
render() {
    return (
        <div className='container'>
            <h2 className='text-uppercase d-block text-center my-4'>Add offer</h2>
            <div className='row '>
                <form onSubmit = {e => {e.preventDefault(); this.onSubmitHandler(this.state)}}  className='d-block col-5 mx-auto shadow p-3 mb-5 mt-1 rounded'>
                     <InputComponent title = 'offer'
                                    ...
                                    />
                    <button type="submit" className="bt btn-dark d-block px-4 py-2 rounded-lg col-sm-5 col-md-12">Add offer</button>
                </form>
            </div>
