...
const Homebody = ()=>{
    ...
    return(
        <div className="mainbody container-fluid mt-4">
           ...
           <div className="col-lg-2 col-sm-12 "><div className="row m2 mb-4"><Suggested news={Data} header="news"></Suggested></div><div className="row m2 mt-4"><Suggested news={Data} header="suggested"></Suggested></div></div>
           </div>
